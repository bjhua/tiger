...
public class Fac
{
  ...
  //main class:"Sum"
  static ast.mainClass.MainClass sum = new ast.mainClass.MainClass("Sum", "a", 
	new ast.stm.Print(new ast.exp.Call(new ast.exp.NewObject("Doit"), "doit", 
  ...
  static ast.classs.Class doit = new ast.classs.Class("Doit", null, 
	...
	new util.Flist<ast.method.T>().addAll(new ast.method.Method(
		...
		"doit", 
		new util.Flist<ast.dec.T>().addAll(
			new ast.dec.Dec(new ast.type.Int(), "n")), 
		new util.Flist<ast.dec.T>().addAll(
