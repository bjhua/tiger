...
public class Tiger
{
  public static void main(String[] args)
  {
    ...
    case C:
      ...
      codegen.C.PrettyPrintVisitor ppc = new codegen.C.PrettyPrintVisitor();
      cAst.accept(ppc);
      String outputName = ppc.getOutputName();
      Runtime cRuntime = Runtime.getRuntime();
      try {
    	  Process proc = cRuntime.exec("gcc -o " + outputName + ".exe " + outputName 
    			  + " ../runtime/runtime.c");
    	  InputStream stderr = proc.getErrorStream();  
          InputStreamReader isr = new InputStreamReader(stderr);  
          BufferedReader br = new BufferedReader(isr);  
          String line = null;  
          System.out.println("Compile infomation of " + outputName +" generated by GCC:");  
          while ((line = br.readLine()) != null)  
              System.out.println(line);  
          System.out.println("");  
          int exitVal = proc.waitFor();  
          System.out.println("Compiling process exitValue: " + exitVal);  
    	  System.out.println("Executable file: " + outputName + ".exe generated.");
      } catch (Exception e) {
  		// TODO Auto-generated catch block
    	  System.out.println("If you are using Eclipse to debug, the working " +
    	  		"directory of Debug Configuration should be set: ${workspace_loc:tiger/bin}!");
    	  System.out.println("Otherwise, make sure that your working directory " +
    	  		"is ${workspace_loc:tiger/bin}");
  		e.printStackTrace();
      }
      break;
    case X86:
